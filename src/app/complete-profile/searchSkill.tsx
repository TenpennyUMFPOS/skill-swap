    ...
    <Dialog onOpenChange={(open) => handleOpenChange(open)}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Enter the name the skill you want to add to your profile. You have{" "}
            {5 - skills.length} left.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="flex-col items-start space-y-2">
          ...
          <Button type="button" variant="default" onClick={searchSkillFromApi}>
            search
          </Button>
        </div>
